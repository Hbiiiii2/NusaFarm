        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between items-center py-4">
                <div class="flex items-center space-x-3">
                    <a href="{{ route('landlord.farmlands.show', $farmland) }}" class="text-gray-400 hover:text-gray-600">
                    ...
                    <div>
                        <h1 class="text-xl font-bold text-gray-900">Edit Lahan</h1>
    ...
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
        ...
        <div class="bg-white rounded-lg shadow">
            <div class="px-6 py-4 border-b border-gray-200">
                <h2 class="text-lg font-semibold text-gray-900">Update Informasi Lahan</h2>
                <p class="text-sm text-gray-600">Perbarui data lahan dan dokumen yang diperlukan</p>
            </div>
            
            <form action="{{ route('landlord.farmlands.update', $farmland) }}" method="POST" enctype="multipart/form-data" class="p-6">
                @csrf
                @method('PUT')
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                    <div>
                        ...
                        <input type="text" id="location" name="location" value="{{ old('location', $farmland->location) }}" required
                    ...
                    <div>
                        ...
                        <input type="number" id="size" name="size" value="{{ old('size', $farmland->size) }}" step="0.1" min="0.1" required
                            class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-green-500"
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                    <div>
                        ...
                        <input type="number" id="rental_price" name="rental_price" value="{{ old('rental_price', $farmland->rental_price) }}" min="0" required
                            class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-green-500"
                    ...
                    <div>
                        ...
                        <input type="text" id="crop_type" name="crop_type" value="{{ old('crop_type', $farmland->crop_type) }}"
                            class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-green-500"
                ...
                <div class="mb-6">
                    ...
                    <textarea id="description" name="description" rows="4"
                        class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-green-500"
                        placeholder="Deskripsikan kondisi lahan, akses jalan, sumber air, dan fasilitas lainnya...">{{ old('description', $farmland->description) }}</textarea>
                </div>
                ...
                <div class="border-t border-gray-200 pt-6">
                    <h3 class="text-lg font-semibold text-gray-900 mb-4">
                        ...
                        Update Dokumen Legalitas
                    </h3>
                    <p class="text-sm text-gray-600 mb-6">Upload dokumen baru untuk mengganti yang lama</p>
                        ...
                        <div>
                            ...
                            <div class="mb-3 p-3 bg-green-50 rounded-lg">
                                <div class="flex items-center">
                                    ...
                                    <span class="text-sm text-green-700">Sertifikat sudah diupload</span>
                                </div>
                            </div>
                            @endif
                            <div class="border-2 border-dashed border-gray-300 rounded-lg p-6 text-center hover:border-green-500 transition-colors">
                                ...
                                <label for="certificate_document" class="cursor-pointer">
                                    ...
                                    <div class="text-sm text-gray-600">
                                        <span class="text-green-600 font-medium">Klik untuk upload</span> sertifikat baru
                                    </div>
                        ...
                        <div>
                            ...
                            <div class="mb-3 p-3 bg-green-50 rounded-lg">
                                <div class="flex items-center">
                                    ...
                                    <span class="text-sm text-green-700">Peta sudah diupload</span>
                                </div>
                            </div>
                            @endif
                            <div class="border-2 border-dashed border-gray-300 rounded-lg p-6 text-center hover:border-green-500 transition-colors">
                                ...
                                <label for="location_map" class="cursor-pointer">
                                    ...
                                    <div class="text-sm text-gray-600">
                                        <span class="text-green-600 font-medium">Klik untuk upload</span> peta baru
                                    </div>
                                    <div class="text-xs text-gray-500 mt-1">
                                        Maksimal 5MB (PDF, JPG, PNG)
                                    </div>
                ...
                <!-- Current Documents -->
                @if($farmland->certificate_path || $farmland->map_path)
                <div class="border-t border-gray-200 pt-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div class="bg-gray-50 rounded-lg p-4">
                            <div class="flex items-center justify-between">
                                <div class="flex items-center">
                                    <i class="fas fa-file-pdf text-red-600 mr-2"></i>
                                    <span class="text-sm font-medium">Sertifikat Lahan</span>
                                </div>
                        ...
                        <div class="bg-gray-50 rounded-lg p-4">
                            <div class="flex items-center justify-between">
                                <div class="flex items-center">
                                    <i class="fas fa-map text-green-600 mr-2"></i>
                                    <span class="text-sm font-medium">Peta Lokasi</span>
                                </div>
                ...
                <div class="flex items-center justify-between pt-6 border-t border-gray-200 mt-6">
                    <a href="{{ route('landlord.farmlands.show', $farmland) }}" class="bg-gray-300 text-gray-700 px-6 py-3 rounded-lg hover:bg-gray-400 transition-colors">
                        Batal
                    </a>
